...
Run one of the SanitizeMe versions via one of the following commands:
```
SanitizeMe_GUI.py
SanitizeMe_CLI.py
...
Deactivate the Conda environment after you run (to protect the environment from clashing with other programs)
```
conda deactivate
```
